...
export function SettingsWindow({ settings, onUpdate }: SettingsWindowProps) {
	...
	const toggleSetting = (
		key: "autostart" | "pause_on_battery" | "pause_on_unfocus" | "is_muted",
	) => {
		onUpdate({
			...settings,
			[key]: !settings[key],
	...
	const setOverlayPosition = (
		...
		const next: Partial<WallpaperOverlay> = {};
	...
	return (
		<div className="flex h-screen w-screen flex-col bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
			...
			<footer className="shrink-0 border-t border-neutral-200 px-4 py-3 text-[9px] text-neutral-400 dark:border-neutral-800">
				<p className="mb-1 text-[10px] text-neutral-500 dark:text-neutral-400">
	...
	return (
		<div className="flex items-center gap-2">
			...
			<button
				...
				className="flex min-w-0 flex-1 cursor-ew-resize items-center justify-between border border-neutral-200 bg-neutral-50 px-2 py-1.5 text-left font-mono text-[10px] text-neutral-700 select-none hover:border-neutral-300 hover:bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:border-neutral-700 dark:hover:bg-neutral-800"
